# Значение строки гугл-таблицы, куда полетит первая запись
order_id = 2
...
#                '©️ FranticDog'
starting_msg = 'Бонжур! Я помогаю Юре организовывать кайфовые кофе-брейки ' + \
...
name_not_text_msg = 'Я понимаю только текстовые сообщения, ' + \
                    'так что будь добр, пальчиками текст набери, пожалуйста 😊'
